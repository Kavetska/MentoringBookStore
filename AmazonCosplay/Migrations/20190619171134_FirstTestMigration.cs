        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true, computedColumnSql: "[FirstName] + ' ' + [LastName]"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPlatform", x => new { x.BookId, x.PlatformId });
                    table.ForeignKey(
                        name: "FK_BookPlatform_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPlatform_Platforms_PlatformId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPlatform_PlatformId",
                table: "BookPlatform",
                column: "PlatformId");
